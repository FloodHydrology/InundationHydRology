...
To-do: Work in unique id into the system....
...
#Step 3: Delineate wetland depressions and their subsheds

Here, we use WhiteBox GAT tools to identify depressions in the DEM, then we will delineate individual subsheds from those depressions. 
...
fun<-function(WetID){
  ...
  #Assign sushed shape to global env
  assign(paste0("subshed_",pnt$WetID), subshed, envir = .GlobalEnv)
}
