...
data_dir<-"//storage.research.sesync.org/njones-data/Research Projects/LULC_CBW/"
...
dem<-raster(paste0(data_dir,"Spatial_Data/NHDPlus02/Elev_Unit_a/elev_cm"))
  p<-dem@crs
gages<-readOGR(paste0(data_dir,"Spatial_Data/NHDPlus02/StreamGageEvent.shp"))
  gages<-gages[gages$SUBREGION %in% c("0205","0206","0207","0208"),]
  gages<-spTransform(gages, p)
HUC08<-readOGR(paste0(data_dir,"Spatial_Data/NHDPlus02/Subbasin.shp"))
  HUC08<-spTransform(HUC08, p)
LULC2001<-raster(paste0(data_dir,"Spatial_Data/nlcd_2001_landcover_2011_edition_2014_10_10/nlcd_2001_landcover_2011_edition_2014_10_10/nlcd_2001_landcover_2011_edition_2014_10_10.img"))
LULC2006<-raster(paste0(data_dir,"Spatial_Data/nlcd_2006_landcover_2011_edition_2014_10_10/nlcd_2006_landcover_2011_edition_2014_10_10.img"))
LULC2011<-raster(paste0(data_dir,"Spatial_Data/nlcd_2011_landcover_2011_edition_2014_10_10/nlcd_2011_landcover_2011_edition_2014_10_10.img"))
...
fun<-function(ID){
  ...
  UID<-pnts$SOURCE_FEA[pnts$FID==ID]
  ...
  system(paste(paste(wbt_dir), 
               ...
               "--d8_pntr='fdr.tif'",
               "--pour_pts='snap.shp'", 
               paste0("-o='watershed_",UID,".tif'")))

  #Import watershed raster into R environment
  ws_grid<-raster(paste0(scratch_dir,"watershed_",UID,".tif"), overwrite=T)
...
#merge output
pnts<-pnts@data
pnts<-merge(pnts, output, by.x="FID", by.y="ID")
...
plot(ws_area~DA_SQ_MILE, data=output, 
     xlab="USGS Estimate", ylab="Jones Estimate", 
