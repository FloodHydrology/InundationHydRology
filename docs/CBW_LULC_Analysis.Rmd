...
The goal of this analysis is to delineate watersheds for points associated with the CBW-LULC project. This spript relies on both the spatial capabilities of R (Raster, sp, and RGDAL packages) in addition to the hydrologic analysis tools in [WhiteBox Tools](http://www.uoguelph.ca/~hydrogeo/WhiteboxTools/index.html) scripting software. Required dataset inlcude a [NHDplus 30-m DEM](http://www.horizon-systems.com/NHDPlus/NHDPlusV1_02.php), [the gagesII database](https://water.usgs.gov/GIS/metadata/usgswrd/XML/gagesII_Sept2011.xml), and finally, [NLCD-LULC data](https://water.usgs.gov/GIS/metadata/usgswrd/XML/gagesII_Sept2011.xml) from the USGS.
